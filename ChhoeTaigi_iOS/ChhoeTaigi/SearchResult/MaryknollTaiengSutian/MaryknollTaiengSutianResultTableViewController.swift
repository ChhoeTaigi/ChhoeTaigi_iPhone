...
class MaryknollTaiengSutianResultTableViewController: UITableViewController {
    ...
    private var results: Results<MaryknollTaiengSutianModel>?
    private var currentSelectedModel: MaryknollTaiengSutianModel?
    ...
    func starSearch() {
        if (searchAllType == SearchAllViewController.SEARCH_ALL_TYPE_LOMAJI) {
            ...
            self.results = RealmDatabaseLoader.getBundledRealm().objects(MaryknollTaiengSutianModel.self).filter(predicate)
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "TableCell", for: indexPath) as! MaryknollTaiengSutianResultTableViewCell
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if (segue.identifier == "segueWordView") {
            let vc = segue.destination as! MaryknollTaiengSutianWordTableViewController
